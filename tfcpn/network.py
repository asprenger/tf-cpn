...
from tfcpn.config import cfg
from tfcpn.tfflat.base import ModelDesc, Trainer
from tfcpn.tfflat.utils import mem_info

from tfcpn.nets.basemodel import resnet50, resnet_arg_scope, resnet_v1
